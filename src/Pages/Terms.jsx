    ...
    return (
        <div className="w-full h-svh flex flex-col items-start justify-start text-black">
            ...
            <div className="w-full h-fit mt-5 pb-20 font-normal flex flex-col items-start justify-start max-w-[800px] mx-auto p-4">
                ...
                <p className="text-sm font-normal text-black/50 mt-2"><strong>Disclaimer:</strong> Countify is NOT a legal tool and does not provide legal advice, services, or consultations. Users are responsible for their own legal decisions and should consult qualified professionals for legal matters.</p>
                {/* 3 */}
